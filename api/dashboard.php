...
<body class="bg-neutral-50 text-dark font-sans antialiased text-base">
           ...
           <div id="view-subscription" class="hidden space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white border border-neutral-200 p-8 rounded-[2rem] shadow-sm flex flex-col justify-between space-y-8">
                        ...
                        <div class="space-y-3">
                            <button id="uploadPaymentProofBtn" onclick="toggleModal('renewalHubModal')" class="w-full bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold py-4 rounded-full transition-all text-center shadow-sm focus:outline-none">
            ...
            <form onsubmit="handleRenewalSubmission(event)" class="space-y-5">
                <div class="bg-neutral-900 text-light p-5 rounded-2xl border border-neutral-800 space-y-3 shadow-inner">
                    ...
                    <div class="text-xs space-y-1.5">
                        ...
                        <div class="flex justify-between"><span class="text-neutral-400">Corporate Mobile Number:</span><span class="font-bold text-white font-mono">0917-888-MONTAG</span></div>
    ...
    <script src="../scripts/dashboard.js?v=1.0.5"></script>
</body>
</html>